...
// AdminListEntitlements returns every driver's entitlements for the admin console.
func (l *LedgerService) AdminListEntitlements(ctx context.Context) ([]*AdminEntitlement, error) {
	return l.repo.ListAllEntitlements(ctx)
}
